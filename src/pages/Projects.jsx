...
const projects = [
  {
    ...
    github: "https://github.com/FFMahani/techstore-frontend",
  ...
  },
  {
    ...
    github: "https://github.com/FFMahani/agency-website-project",
  ...
  },
  {
    ...
    github: "https://github.com/FFMahani/todo-app",
  ...
  },
  {
    ...
    github: "https://github.com/FFMahani/my-portfolio",
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="px-[1.5rem] pt-[1rem] pb-[2rem] flex flex-col h-full">
                ...
                <div className="flex flex-col lg:flex-row gap-3 mt-auto w-full">
                  <a
                    href={project.link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full lg:flex-1 flex-1 text-center px-[1.25rem] py-[0.75rem] text-[0.9rem] font-bold text-white rounded-full bg-gradient-to-r from-[#4ca7d8] via-[#0a6ab3] to-[#073b7c] hover:scale-105 hover:shadow-lg transition-all"
                  >
                    🔗 View Project
                  </a>
                  ...
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full lg:flex-1 flex-1 text-center px-[1.25rem] py-[0.75rem] text-[0.9rem] font-bold text-white rounded-full bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-400 hover:scale-105 hover:shadow-lg transition-all"
                    >
                      💻 GitHub
                    </a>
                  )}
